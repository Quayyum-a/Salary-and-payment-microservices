...
/**
 * Mount payments router before body parsers so webhook raw body can be verified.
 * The payments route uses express.raw at the route level to access raw payload.
 */
...
/**
 * Salary routes (require JSON body and auth)
 */
